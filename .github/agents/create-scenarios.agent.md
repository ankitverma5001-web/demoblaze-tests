...
1. `demoblaze-domain` skill — Start here for verified page selectors, flows, and dialog handling
2. Feature files in `features/` — Review existing Gherkin scenarios
3. Existing tests in `tests/` and `features/step_definitions/` — Understand current coverage
4. DemoBlaze application — https://www.demoblaze.com/index.html (live target site)
...
## Output Format
Write to **`specs/test-scenarios.md`**. Use this template:
